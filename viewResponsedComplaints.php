...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>View Responsed Complaint Page</title>
...
<!-- Form Name -->
<center><legend>Responsed Complaint</legend></center>

<!-- Text input-->


<!-- Text input-->
<table id="viewResponsedComplaints" class="table table-striped table-bordered" style="width:100%">
	                    <thead>
                        <tr>
                            <th>ID</th>
						...
						<tbody>
						<?php
                    $query = "SELECT * from complaints where status = '1' and stu_username='".$_SESSION['username']."'";  
               ...
               if($result->num_rows > 0) {
                ...
                <tr>
						...
						<td><a href="download.php?id=<?php echo $row["complaint_id"];?>">timetable</a></td>
...
$(document).ready(function() {
    $('#viewResponsedComplaints').DataTable();
} );
