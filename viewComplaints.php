...
<!-- Text input-->
<table id="viewComplaints" class="table table-striped table-bordered" style="width:100%">
	                    <thead>
                        <tr>
                            <th>ID</th>
						...
						<tbody>
						<?php
                    $query = "SELECT c.complaint_id, c.student_complaint,c.admin_response, s.student_id, s.email, s.phone_no, c.stu_username from complaints c, student s where s.username = c.stu_username and c.status = '0'";  
               ...
               if($result->num_rows > 0) {
                ...
                <tr>
						...
						<td><a href="replyComplaint.php?id=<?php echo $row['complaint_id']; ?>">Reply</a></td>
                    </tr>
					<?php
                    }
                    ?>
